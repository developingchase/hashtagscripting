...
#Run in /etc/openvpn/easy-rsa

import subprocess
#subprocess.call(["command1", "arg1", "arg2"])

#define names of keys - script will create a unique cert for each name in the list
keynames = ("dolamp","alfred")

#set IP address of VPN server
ipaddr = "xx.xx.xx.xx"

for thiskey in keynames:
        #Update vars config --- NOT WORKING
